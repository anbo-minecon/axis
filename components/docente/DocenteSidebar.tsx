...
// ── Nav items del docente ──────────────────────────────────────────────────
const NAV_ITEMS = [
  { href: "/docente/dashboard",  label: "Dashboard",        icon: LayoutDashboard },
  { href: "/docente/grupos",     label: "Mis Grupos",       icon: Users },
  { href: "/docente/simulacros", label: "Crear Simulacro",  icon: ClipboardList },
  { href: "/docente/importar",   label: "Importar Excel",   icon: FileSpreadsheet },
...
// ── Export principal ───────────────────────────────────────────────────────
export function DocenteSidebar({ user, isOpen, onClose, estudiantesSinGrupo = 0 }: DocenteSidebarProps) {
  return (
    <>
